...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 02-Mar-2020 às 00:32
...
CREATE TABLE IF NOT EXISTS `estabelecimento` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_estabelecimento_status` (`id_status`),
  KEY `FK_estabelecimento_categoria` (`id_categoria`)
...
INSERT INTO `estabelecimento` (`id`, `razao_social`, `nome_fantasia`, `cnpj`, `email`, `endereco`, `cidade`, `estado`, `telefone`, `data_cadastro`, `id_categoria`, `id_status`, `agencia`, `conta`) VALUES
(5, 'Empres Teste', 'Testando 12345', '15.296.667/0001-50', 'teste@teste.com.brr', 'Rua das Margaridas 172', '', '', '11943071441', '2020-03-01 00:00:00', 1, 1, '555-8', '12.345-6'),
(4, 'Empres Teste', 'Testando 123', '09.604.520/0001-88', 'teste@teste.com.br', 'Rua das Margaridas 172', '5215', '26', '11943071441', '2020-03-01 00:00:00', 1, 1, '555-5', '12.345-6'),
(7, 'Empres Teste1', 'GTech Informatica', '15.296.667/0001-50', 'gtech@teste.com.br', 'Rua das Margaridas 179', '3607', '19', '', '2020-03-02 00:00:00', 3, 1, '555-5', '14.555-5'),
(8, 'Empres Teste 5', 'Tenda Atacado', '09.604.520/0001-88', 'teste@teste.com.br', 'Rua das Margaridas 179', '4363', '21', '11943071441', '2020-03-03 00:00:00', 1, 1, '888-8', '65.888-8');
